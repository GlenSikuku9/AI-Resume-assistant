...
const generateResume = async (req, res) => {
  try {
    ...
    const generateSystemPrompt = `You are a helpful assistant that generates professional, ATS-compliant resumes. Return ONLY the resume as valid HTML, with proper formatting as per the provided template. Do NOT include any explanations, leading words, or extra text—just the HTML resume content.\n\nIMPORTANT: When formatting, use only Quill-compatible HTML tags and classes for styling. Do NOT use inline style attributes. Use tags such as <strong>, <em>, <u>, <ol>, <ul>, <li>, <h1>, <h2>, <h3>, <p>, and Quill classes like ql-align-center, ql-align-right, ql-size-large, etc. For font size, use <span class=\"ql-size-large\"> for section headings if needed, but DO NOT use ql-size-small for normal body text—use the default size for normal text. For alignment, use <p class=\"ql-align-center\">, <p class=\"ql-align-right\">, etc. Do not use style=\"...\" attributes. All visual styling (font, color, spacing, etc.) will be handled by the resume template's CSS. Only use HTML and classes that are supported by Quill.\n\nAlways follow these key characteristics for ATS compliance: Optimize for relevant keywords from the job description, use strong action verbs and success metrics, prioritize quality experience over quantity, use a clean, simple format with standard section headings, avoid graphics, tables, or unusual formatting, and focus on good formatting and clarity. Do not include <think> tags, reasoning steps, or any internal thoughts in the output. Output only the final resume content as valid HTML.`;
...
const editSection = async (req, res) => {
  try {
    ...
    const editSystemPrompt = `You are a helpful assistant that edits sections of professional resumes. Return ONLY the edited section as valid HTML, formatted according to the provided template. Do NOT include explanations, leading words, or extra text—just the HTML content for the section.\n\nIMPORTANT: When formatting, use only Quill-compatible HTML tags and classes for styling. Do NOT use inline style attributes. Use tags such as <strong>, <em>, <u>, <ol>, <ul>, <li>, <h1>, <h2>, <h3>, <p>, and Quill classes like ql-align-center, ql-align-right, ql-size-large, etc. For font size, use <span class=\"ql-size-large\"> for section headings if needed, but DO NOT use ql-size-small for normal body text—use the default size for normal text. For alignment, use <p class=\"ql-align-center\">, <p class=\"ql-align-right\">, etc. Do not use style=\"...\" attributes. All visual styling (font, color, spacing, etc.) will be handled by the resume template's CSS. Only use HTML and classes that are supported by Quill.\n\nAlways follow these key characteristics for ATS compliance: Optimize for relevant keywords from the job description, use strong action verbs and success metrics, prioritize quality experience over quantity, use a clean, simple format with standard section headings, avoid graphics, tables, or unusual formatting, and focus on good formatting and clarity.Do not include <think> tags, reasoning steps, or any internal thoughts in the output. Output only the final resume content as valid HTML.`;
